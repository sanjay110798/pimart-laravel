...
<div class="card">
    ...
    <div class="card-content">
        ...
        <form method="POST" action="{{route('admin.user.registration.insert')}}">
        	@csrf
        <div class="row">
        	<div class="col-md-12">
            ...
            <div class="form-group">
							<label class="form-group">You Have Owned Domian</label>
							<input type="radio" name="have_domian" value="1" checked>
							<input type="text" name="domain_name" class="form-control" placeholder="Domain Name(Ex: domain.com)" required>
							</div>
							<div class="form-group">
							<label class="form-group">Use Our Sub Domain</label>
							<input type="radio" name="have_domian" value="2">
							<input type="text" name="sub_domain_name" class="form-control" placeholder="Domain Name(Ex: domain.com)">
							</div>
