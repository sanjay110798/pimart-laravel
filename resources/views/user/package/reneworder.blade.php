...
<div class="form">
      ...
      <div class="form__right">
        ...
        <div class="form__right__form-control">
          ...
          >
          <a href="{{route('add.renewal',['pack_id'=>$pack_id,'p_type'=>$paymenttype,'order_id'=>$ord_id])}}"><button class="form__right__form-control--button" onclick="return confirm('Are you sure?')">Payment Now</button></a>
        </div>
      </div>
    </div>
