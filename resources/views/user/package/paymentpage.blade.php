...
<div class="form">
      ...
      <div class="form__right">
        ...
        <p class="form__right__info">Choose Your Payment Pack</p>
        <div class="form__right__check">
          <input type="radio" name="price_amount" id="option12" value="month" checked />
          <label for="option12" class="form__right__check--creditCard">
      
            <span class="form__right__check--creditCard__text"
              >₹{{$package->monthly_payment}}/Mo</span
            >
          </label>

          <input type="radio" name="price_amount" id="option22" value="year"/>
          <label for="option22" class="form__right__check--payPal">₹{{$package->yearly_payment}}/Yr
          </label>
        </div>
        ...
        <div class="form__right__form-control">
          ...
          >
          <button type="submit" class="form__right__form-control--button" onclick="return confirm('Are you sure?')">Payment Now</button>
        </div>
      </div>
      </form>
    </div>
...
#option12:checked ~ .form__right__check--creditCard {
  border-color: blue;
}

#option12:checked ~ .form__right__check--creditCard::after {
  border-color: green;
  outline: 2px solid green;
  outline-offset: -10px;
  outline-style: dotted;
...
#option22:checked ~ .form__right__check--payPal {
  border-color: blue;
}

#option22:checked ~ .form__right__check--payPal::after {
  border-color: green;
  outline: 2px solid green;
  outline-offset: -10px;
  outline-style: dotted;
