...
<div class="card">
    ...
    <div class="card-content">
        ...
        <h4 class="card-title">Make Your App</h4>
        ...
        <form method="POST" action="{{route('save.app.details')}}">
            @csrf
                ...
                <div class="app_from">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="app_info" rows="8" required></textarea>
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" name="app_color" id="app_color">
                        ...
                        <button type="submit" class="btn btn-primary continue_btn">Save</button>
                    </div>
        </div>
...
<div class="col-md-12">
    ...
    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="mx-auto overflow-hidden v-card v-sheet theme--light" style="max-width: 350px;">
                            <header class="v-sheet v-sheet--tile theme--dark v-toolbar v-app-bar mobile_header" style="height: 64px; margin-top: 0px; transform: translateY(0px); left: 0px; right: 0px; background-color: {{$userReg->app_color}}; border-color: rgb(77, 175, 182);" data-booted="true">
                                <div class="v-toolbar__content" style="height: 64px;">
...
<div class="col-md-12">
<a href="{{$userReg->app_dwn_url}}" class="btn btn-primary">Download App</a>
</div>
@endif
<!-- end col-md-12 -->
